extends Control
# https://godotengine.org/asset-library/asset/2756
const MARGIN = 0
...
func _process(_delta):
	...
	var viewport_base_size = (
			...
			#Globals.activeTv.currentViewport.content_scale_size if Globals.activeTv.currentViewport.content_scale_size > Vector2i(0, 0)
			#else Globals.activeTv.currentViewport.size
			Vector2i (630,500)
	)
	#print ("vpbs", viewport_base_size)
...
func showBubble(dialog, duration) :
	text = dialog
